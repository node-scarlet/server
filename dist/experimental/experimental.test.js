...
function streamResponseTest() {
    return __awaiter(this, void 0, void 0, function () {
        var description, streamFile, requests, first, _a, _b, e_3;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    description = "Stream objects should be\n  acceptable response body material";
                    _c.label = 1;
                case 1:
                    _c.trys.push([1, 6, , 7]);
                    streamFile = function (req, meta) {
                        return http.response({
                            status: 200,
                            headers: {},
                            body: fs_1.createReadStream(__dirname + '/static/index.html'),
                        });
                    };
                    requests = http.server();
                ...
                case 3:
                    first = _c.sent();
                    assert_1.strict(first.ok);
                    _b = (_a = assert_1.strict).deepEqual;
                    return [4 /*yield*/, first.text()];
                case 4:
                    _b.apply(_a, [_c.sent(), '<h1>Hello World!</h1>']);
                    return [4 /*yield*/, requests.close()];
                case 5:
                    _c.sent();
                    return [3 /*break*/, 7];
...
//# sourceMappingURL=experimental.test.js.map